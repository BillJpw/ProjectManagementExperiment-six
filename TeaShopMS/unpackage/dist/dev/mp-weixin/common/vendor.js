...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"茶店项目协作","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 30 */
/*!************************************************************!*\
  !*** D:/GradeThree/ProjectManagement/TeaShopMS/pages.json ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 37 */
/*!****************************************************************!*\
  !*** D:/GradeThree/ProjectManagement/TeaShopMS/store/index.js ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 48 */
/*!**************************************************************!*\
  !*** D:/GradeThree/ProjectManagement/TeaShopMS/api/index.js ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _objectWithoutProperties2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/objectWithoutProperties */ 49));
var _asyncToGenerator2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ 47));
var _mock = __webpack_require__(/*! ./mock.js */ 51);
...
var api = {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              return delay();
            case 2:
              user = _mock.mockUsers.find(function (u) {
              ...
              _ = user.password, userInfo = (0, _objectWithoutProperties2.default)(user, _excluded);
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              return delay();
            case 2:
              project = _mock.mockProjects.find(function (p) {
                return p.id === id;
              });
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 2:
              if (!project.id) {
                project.id = Date.now();
                _mock.mockProjects.push(project);
              }
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              return delay();
            case 2:
              task = _mock.mockTasks.find(function (t) {
                return t.id === id;
              });
  ...
  getComments: function getComments(taskId) {
        ...
        while (1) {
          switch (_context9.prev = _context9.next) {
            case 0:
              ...
              return delay();
            case 2:
              comments = _mock.mockComments.filter(function (c) {
      ...
      return _regenerator.default.wrap(function _callee10$(_context10) {
        while (1) {
          switch (_context10.prev = _context10.next) {
            ...
            case 2:
              comment.id = Date.now();
              _mock.mockComments.push(comment);
  ...
  getStatistics: function getStatistics() {
    return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee14() {
      var totalProjects, doneProjects, totalTasks, doneTasks, overdueTasks;
        ...
        while (1) {
          switch (_context14.prev = _context14.next) {
            case 0:
              ...
              return delay();
            case 2:
              totalProjects = _mock.mockProjects.length;
              doneProjects = _mock.mockProjects.filter(function (p) {
                return p.status === 'done';
              }).length;
              totalTasks = _mock.mockTasks.length;
              doneTasks = _mock.mockTasks.filter(function (t) {
                return t.status === 'done';
              }).length;
              overdueTasks = _mock.mockTasks.filter(function (t) {
                return t.status !== 'done' && new Date(t.deadline) < new Date();
              }).length;
...
var objectWithoutPropertiesLoose = __webpack_require__(/*! ./objectWithoutPropertiesLoose.js */ 50);
...
/* 51 */
/*!*************************************************************!*\
  !*** D:/GradeThree/ProjectManagement/TeaShopMS/api/mock.js ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.mockUsers = exports.mockTasks = exports.mockProjects = exports.mockProducts = exports.mockMaterials = exports.mockEquipments = exports.mockComments = void 0;
var mockUsers = [{
  id: 1,
  username: 'admin',
  password: '123456',
...
var mockProjects = [{
  ...
  endTime: '2026-04-22',
  description: '门店制冰机季度保养维护',
  priority: 'high',
  status: 'in_progress',
  progress: 50
}];
exports.mockProjects = mockProjects;
var mockTasks = [{
  id: 1,
  projectId: 1,
  title: '樱花粉配方调试',
...
exports.mockComments = mockComments;
var mockProducts = [{
  id: 1,
  name: '樱花粉奶茶',
  formula: '红茶底 + 樱花酱 + 牛奶',
  materials: ['红茶', '樱花酱', '牛奶'],
  testRecords: ['2026-04-10测试通过'],
  status: 'testing'
}];
...
exports.mockEquipments = mockEquipments;
var mockMaterials = [{
  id: 1,
  name: '红茶',
  stock: 50,
...
exports.mockMaterials = mockMaterials;
